...
void ProtocolGame::parsePacket(NetworkMessage& msg)
{
	...
	//std::cout << "RECVBYTE " << static_cast<int>(recvbyte) << std::endl;
	...
	if (msg.isOverrun()) {
		//std::cout << "RECVBYTE AGAIN " << static_cast<int>(recvbyte) << std::endl;
		disconnect();
	}
}
...
void ProtocolGame::parseDash(NetworkMessage& msg)
{
	addGameTask(&Game::playerDash, player->getID());
}
