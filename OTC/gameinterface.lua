...
function bindKeys()
  ...
  --Add Toggle for JumpGame
  g_keyboard.bindKeyDown('J', function()
    showJumpGame()
  end, gameRootPanel)

  --Add Dash Keybindings
...
function dash()
  local function resetShader()
    g_game.getLocalPlayer():resetShader()
  end

  local player = g_game.getLocalPlayer()
  player:setShader("red_outline")

  g_game.dash()

  --Avoiding sending Server->Client Message for now
  scheduleEvent(resetShader, 350)
end
